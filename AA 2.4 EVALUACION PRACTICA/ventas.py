...
ventas_dolares = list(map(lambda x: round(x / tipo_cambio, 2), ventas_pesos))
ventas_mayores = list(filter(lambda x: x > 150, ventas_dolares))
suma_total_mayores_150 = round(reduce(lambda x, y: x + y, ventas_mayores, 0), 2)

print("El promedio total en pesos es:", round(promedio_ventas, 2))
print("Las ventas de la semana en dólares son:", ventas_dolares)
