...
ventas_dolares =list(map(lambda x:x /tipo_cambio, ventas_pesos))
ventas_mayores =list(filter(lambda x: x > 150,ventas_dolares ))
suma_total_mayores_150 = reduce(lambda x, y: x + y, ventas_mayores, 0)

print("el promedio total es:", promedio_ventas)
