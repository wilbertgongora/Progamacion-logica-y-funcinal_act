...
peliculas_nolan = list( map(lambda pelicula: { "Titulo": pelicula["Titulo"], "CalificaciónIMDB": float(pelicula["CalificaciónIMDB"]) },
     
        filter( lambda pelicula: pelicula["Director"] == "Christopher Nolan", peliculas )
    )
)
